...
$$
s_{sat}=w_{11}x_1+w_{12}x_2+b_1
$$

### Unit 2: `ran`

$$
s_{ran}=w_{21}x_1+w_{22}x_2+b_2
$$

### Unit 3: `flew`

$$
s_{flew}=w_{31}x_1+w_{32}x_2+b_3
$$
...
$$
\boxed{
W.grad_i=(output\_gradient_i)\times x
}
$$
...
$$
w_1x_1+w_2x_2+\cdots+w_{100}x_{100}
$$
...
$$
\frac{\partial output}{\partial weight}=input
$$
